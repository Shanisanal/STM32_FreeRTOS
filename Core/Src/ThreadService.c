...
//***************************** Local Variables *******************************
osThreadId_t gpPollerThreadId      = NULL;
...
osThreadId_t gpTrasnsportThreadId     = NULL;
...
osThreadId_t gpLoggerThreadId     = NULL;
...
{
	{ &gpPollerThreadId,    ThreadHandlerPoller,    &stPollerAttr,    NULL },
	{ &gpTrasnsportThreadId,ThreadHandlerTransport, &stTrasnsportAttr,NULL },
	{ &gpLoggerThreadId,	ThreadHandlerLogger,    &stLoggerAttr,    NULL },
};
...
//*************************** ThreadServiceCreateDataQueue ********************
//Purpose   : Create Data Queue.
...
//Notes     : None
//*****************************************************************************
bool ThreadServiceCreateDataQueue(const IPC_DEFINITION* pstDataQueue)
{
    bool blStatus = true;
